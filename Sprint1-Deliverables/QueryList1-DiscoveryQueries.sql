...
### Purpose  
This query identifies high-value customers based on total spending. It can support loyalty programs, targeted marketing, and VIP customer segmentation strategies.
...
### Purpose  
This query compares pricing across room categories. It helps management evaluate pricing strategy and understand differences between room tiers.

---

## 3️⃣ Revenue by Product / Service  
...
### Purpose  
This query highlights which services or products contribute most to total revenue. It can support upselling strategies and revenue optimization decisions.
